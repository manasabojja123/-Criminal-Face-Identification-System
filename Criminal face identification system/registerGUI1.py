...
photo_label = Label(image=photo, width=500, height=500)
...
label_0 = Label(root, text="Registration Form",width=115,font=("bold", 16),bg="#180020",fg='white')
label_0.place(x=0,y=42)
...
Radiobutton(root, text="Others",padx = 20, variable=gen, value=3).place(x=395,y=280)
